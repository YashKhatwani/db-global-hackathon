# Welcome, caretechers, to the 2024 TDI Global Hackathon
## Contents
...
8. Navigate to https://console.cloud.google.com/home/dashboard?project=hack-team-caretechers.
...
You have an "infrastructure SA" (infrastructure@hack-team-caretechers.iam.gserviceaccount.com) with the same IAM permissions as team members.
...
you must attach your Workload SA (workload@hack-team-caretechers.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom SA".
...
(typically `"serviceAccount": "workload@hack-team-caretechers.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."` or `"displayName" : "..."` attribute) 
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-caretechers)
